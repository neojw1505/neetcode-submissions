...
class Solution:
    def copyRandomList(self, head: 'Optional[Node]') -> 'Optional[Node]':
        ...
        old_to_new = {None: None} # Because both the .next and .random pointers can point to None, your code is guaranteed to look up None in the dictionary at some point 
        curr = head
        while curr:
